...
twitter_data.each do |user|
  user.each { |name, info| puts "#{name}: #{info["number of followers"]}" }
end
puts
...
twitter_data.each do |user|
  user.each do |name, info|
    twenty_tweets = (info["last twenty tweets"].map {|i| i.length}).inject(:+)
    puts "#{name} used #{twenty_tweets} characters in their last twenty tweets."
  end
end
puts
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # #
...
twitter_data.each do |user|
  user.each do |name, info|
    followers.push(info["number of followers"])
  end
end
twitter_data.each do |user|
  user.each do |name, info|
    puts name if info["number of followers"] == followers.max
  end
end
puts
...
twitter_data.each do |user|
  user.each do |name, info|
    friends.push(info["number of friends"])
  end
end
twitter_data.each do |user|
  user.each do |name, info|
    puts name if info["number of friends"] == friends.max
  end
end
puts
...
twitter_data.each do |user|
  user.each do |name, info|
    tweets.push(info["number of tweets"])
  end
end
twitter_data.each do |user|
  user.each do |name, info|
    puts name if info["number of tweets"] == tweets.max
  end
end
puts
...
twitter_data.each do |user|
  user.each do |name, info|
    puts name if !(info["description"].nil?)
  end
end
puts
...
twitter_data.each do |user|
  user.each do |name, info|
    puts name if !(info["location"].nil?)
  end
end
